...
To get a feel for the data returned by this API, check out <https://merrysky.net>! 
...
If you get an `AttributeError: PRECIPITATION` upon importing the integration please check that you are running HA 2022.12 or later. If you are running an earlier try updating your HA installation to the latest version if possible. If you are unable to update your version of HA then you can use the [legacy branch](https://github.com/alexander0042/pirate-weather-ha/tree/Legacy-Dark-Sky) instead.
