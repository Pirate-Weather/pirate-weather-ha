...
SENSOR_TYPES: dict[str, PirateWeatherSensorEntityDescription] = {
    ...
    "snow_intensity": PirateWeatherSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.PRECIPITATION,
        state_class=SensorStateClass.MEASUREMENT,
        si_unit=UnitOfVolumetricFlux.CENTIMETERS,
        us_unit=UnitOfLength.INCHES,
        ca_unit=UnitOfVolumetricFlux.CENTIMETERS,
        uk_unit=UnitOfVolumetricFlux.CENTIMETERS,
        uk2_unit=UnitOfVolumetricFlux.CENTIMETERS,
        suggested_display_precision=4,
        icon="mdi:weather-snowy",
        forecast_mode=["currently", "hourly", "daily"],
    ),
    ...
    "ice_intensity_max": PirateWeatherSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.PRECIPITATION,
        state_class=SensorStateClass.MEASUREMENT,
        si_unit=UnitOfLength.MILLIMETERS_PER_HOUR,
        us_unit=UnitOfLength.INCHES,
        ca_unit=UnitOfLength.MILLIMETERS_PER_HOUR,
        uk_unit=UnitOfLength.MILLIMETERS_PER_HOUR,
        uk2_unit=UnitOfLength.MILLIMETERS_PER_HOUR,
        suggested_display_precision=4,
        icon="mdi:weather-snowy-rainy",
        forecast_mode=["daily"],
    ),
